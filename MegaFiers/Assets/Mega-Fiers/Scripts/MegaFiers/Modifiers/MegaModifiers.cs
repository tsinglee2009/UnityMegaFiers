...
public class MegaModifiers : MonoBehaviour
{
	...
	{
        //MegaModifier mod = (MegaModifier)UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(gameObject, "Assets/Mega-Fiers/Scripts/MegaFiers/Modifiers/MegaModifiers.cs (611,36)", type);
        MegaModifier mod = gameObject.AddComponent<MegaModifier>();
        if ( mod != null )
			BuildList();
